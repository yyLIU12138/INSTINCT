...
if not os.path.exists(save_dir + f'{mode}/comparison/STAligner/'):
    os.makedirs(save_dir + f'{mode}/comparison/STAligner/')
...
for j in range(num_iters):
    ...
    with open(save_dir + f'{mode}/comparison/STAligner/STAligner_embed_{j}.csv', 'w', newline='') as file:
