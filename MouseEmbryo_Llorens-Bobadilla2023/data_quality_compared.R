...
save_dir <- 'C:/University/FINAL/results/MouseEmbryo_Llorens-Bobadilla2023/data_quality_compared/'
if (!dir.exists(save_dir)) {
    dir.create(save_dir, recursive = TRUE)
}

inputFiles = c("D:/Data/spMOdata/EpiTran_MouseBrain_Jiang2023/S1/E11_0-S1_filtered_fragments.tsv.bgz",
               "D:/Data/spMOdata/EpiTran_MouseBrain_Jiang2023/S1/E13_5-S1_filtered_fragments.tsv.bgz",
               "D:/Data/spMOdata/EpiTran_MouseBrain_Jiang2023/S1/E15_5-S1_filtered_fragments.tsv.bgz",
               "D:/Data/spMOdata/EpiTran_MouseBrain_Jiang2023/S1/E18_5-S1_filtered_fragments.tsv.bgz",
...
sampleNames = c("MISAR-seq MB_E11.0-S1",
                "MISAR-seq MB_E13.5-S1",
                "MISAR-seq MB_E15.5-S1",
                "MISAR-seq MB_E18.5-S1",
...
p1 <- plotGroups(
    ...
    groupBy = "Sample", 
    colorBy = "cellColData", 
    pal = unlist(list("MISAR-seq MB_E11.0-S1"="#FF4500", "MISAR-seq MB_E13.5-S1"="#32CD32",
                      "MISAR-seq MB_E15.5-S1"="#1E90FF", "MISAR-seq MB_E18.5-S1"="#FFD700",
                      "spatial ATAC ME15.5-S1"="#00CED1", "spatial ATAC ME15.5-S2"="#00FFFF",
