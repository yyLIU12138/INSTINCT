...
from ..evaluation_utils import cluster_metrics, batch_correction_metrics, bio_conservation_metrics, match_cluster_labels
...
for i in range(len(titles)):
    ...
    if not os.path.exists(f'../../results/model_validity/MouseBrain_Jiang2023/{titles[i]}/{titles[i]}_results_dict.pkl'):
        ...
        with open(f'../../results/model_validity/MouseBrain_Jiang2023/{titles[i]}/{titles[i]}_results_dict.pkl',
                  'wb') as file:
    ...
    for j in range(num_iters):
        ...
        embed = pd.read_csv(f'../../results/model_validity/MouseBrain_Jiang2023/{titles[i]}/{titles[i]}_embed_{j}.csv',
                            header=None).values
