...
# parameters
lambda_list = [1, 5, 10, 15, 20, 25, 30]
...
if not os.path.exists('../../results/model_validity/MouseBrain_Jiang2023/sensitivity/losses_hyper/'):
    os.makedirs('../../results/model_validity/MouseBrain_Jiang2023/sensitivity/losses_hyper/')
...
for i in range(len(lambda_list)):
    ...
    print(f'lambda_cls is {lambda_list[i]}\n')

    for k in range(num_iters):

        print(f'Iteration {k}')

        INSTINCT_model = INSTINCT_Model(cas_list, adata_concat, lambda_cls=lambda_list[i], lambda_la=20, lambda_rec=10,
        ...
        with open(f'../../results/model_validity/MouseBrain_Jiang2023/sensitivity/losses_hyper/lambda_cls={lambda_list[i]}_embed_{k}.csv',
                  'w', newline='') as file:
...
for i in range(len(lambda_list)):
    ...
    print(f'lambda_la is {lambda_list[i]}\n')

    for k in range(num_iters):

        print(f'Iteration {k}')

        INSTINCT_model = INSTINCT_Model(cas_list, adata_concat, lambda_cls=10, lambda_la=lambda_list[i], lambda_rec=10,
                                        seed=1236+k, device=device)
        ...
        with open(f'../../results/model_validity/MouseBrain_Jiang2023/sensitivity/losses_hyper/lambda_la={lambda_list[i]}_embed_{k}.csv',
                  'w', newline='') as file:
            writer = csv.writer(file)
            writer.writerows(result.obsm['INSTINCT_latent'])
...
for i in range(len(lambda_list)):
    ...
    print(f'lambda_rec is {lambda_list[i]}\n')

    for k in range(num_iters):

        print(f'Iteration {k}')

        INSTINCT_model = INSTINCT_Model(cas_list, adata_concat, lambda_cls=10, lambda_la=20, lambda_rec=lambda_list[i],
                                        seed=1236+k, device=device)
        ...
        with open(f'../../results/model_validity/MouseBrain_Jiang2023/sensitivity/losses_hyper/lambda_rec={lambda_list[i]}_embed_{k}.csv',
                  'w', newline='') as file:
            writer = csv.writer(file)
            writer.writerows(result.obsm['INSTINCT_latent'])
