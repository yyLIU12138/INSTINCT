...
save_dir <- paste('C:/University/FINAL/results/simulated/scenario_1/T_', name_concat, '/', sep = '')
...
ggsave(paste0(save_dir, 'comparison/methods_mean_overview_table.pdf'), g1, width = 10, height = 7)
ggsave(paste0(save_dir, 'comparison/methods_median_overview_table.pdf'), g2, width = 10, height = 7)
