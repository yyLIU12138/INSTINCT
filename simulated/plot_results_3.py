...
save_dir = f'../../results/simulated/scenario_{scenario}/T_' + name_concat + '/comparison/Harmony_Seurat/'
...
# models = ['INSTINCT', 'INSTINCT_500', 'INSTINCT_1000']
# labels1 = ['INSTINCT', 'INSTINCT_500', 'INSTINCT_1000']
# color_list_1 = ['darkviolet', 'dodgerblue', 'deepskyblue']
...
for model_name in models:
    ...
    with open(f'../../results/simulated/scenario_{scenario}/T_{name_concat}/comparison/{model_name}/{model_name}_results_dict.pkl', 'rb') as file:
